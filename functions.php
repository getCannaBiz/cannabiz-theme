...
function cannabiz_scripts() {
	...
	wp_enqueue_script( 'cannabiz-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20170926', true );
	wp_enqueue_script( 'cannabiz-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20170926', true );
	wp_enqueue_script( 'cannabiz-bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', array(), '20170926', true );
	wp_enqueue_script( 'cannabiz-hoverIntent', get_template_directory_uri() . '/js/hoverIntent.min.js', array(), '20170926', true );
	wp_enqueue_script( 'cannabiz-js', get_template_directory_uri() . '/js/cannabiz.js', array(), '20170926', true );
